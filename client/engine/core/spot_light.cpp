...
namespace engine {
  ...
  SpotLight::~SpotLight() {
    delete m_marker;
    qDebug() << "Spotlight" << this->objectName() << "is destroyed";
  }
  ...
  void SpotLight::setInnerCutOff(float innerCutOff) {
    if (!isEqual(m_innerCutOff, innerCutOff)) {
      ...
      qDebug() << "The inner cut-off of" << this->objectName() << "is set to" << innerCutOff;
  ...
  void SpotLight::setOuterCutOff(float outerCutOff) {
    if (!isEqual(m_outerCutOff, outerCutOff)) {
      ...
      qDebug() << "The outer cut-off of" << this->objectName() << "is set to" << outerCutOff;
  ...
  void SpotLight::setEnableAttenuation(bool enabled) {
    if (m_enableAttenuation != enabled) {
      ...
      qDebug() << "The attenuation of" << this->objectName()
  ...
  void SpotLight::setAttenuationQuadratic(float value) {
    if (!isEqual(m_attenuationQuadratic, value)) {
      ...
      qDebug() << "The quadratic attenuation arg of" << this->objectName()
           << "is set to" << value;
  ...
  void SpotLight::setAttenuationLinear(float value) {
    if (!isEqual(m_attenuationLinear, value)) {
      ...
      qDebug() << "The linear attenuation arg of" << this->objectName()
           << "is set to" << value;
  ...
  void SpotLight::setAttenuationConstant(float value) {
    if (!isEqual(m_attenuationConstant, value)) {
      ...
      qDebug() << "The constant attenuation arg of" << this->objectName()
           << "is set to" << value;
